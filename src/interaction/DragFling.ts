...
import {Motor, type RenderTask} from 'lume/src/core/Motor.js'
import {Settable} from 'lume/dist/utils/Settable.js'
...
export class DragFling extends Settable(Effects) {
	...
	@signal target: HTMLElement | SVGElement = document.documentElement
	...
	#onUp = () => {
		...
		console.log('pointer up, count:', this.#pointerCount)
		if (this.#pointerCount === 0) {
			...
			console.log('pointer up, count 0, remove listener')
		}
